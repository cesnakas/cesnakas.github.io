...
if ($(window).width() < 991.98) {
    ...
    $('#userpic').removeClass('w-75').addClass('mb-4');
    $('#userpic img').removeClass('p-3').addClass('p-2');
} else {
    $('body').addClass('py-5');
    ...
    $('#userpic').addClass('w-75').removeClass('mb-4');
    $('#userpic img').removeClass('p-2').addClass('p-3');
};
